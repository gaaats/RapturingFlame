package com.supersolid.honestfoo.gaaame
...
import com.supersolid.honestfoo.R
...
class GameerVieva(
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        uuu = this@GameerVieva.measuredWidth
        kikiik = this@GameerVieva.measuredHeight
    ...
    private fun vvcvv(canvas: Canvas): Boolean {
        ...
        for (i in gtgtjt.indices) {
            ...
            val mjmkmkmk = resources.getDrawable(R.drawable.fourlist, null)
